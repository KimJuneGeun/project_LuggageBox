...
public class dealcompleteAdapter extends BaseAdapter {

    private ArrayList<ApplyList> listViewItemList = new ArrayList<ApplyList>() ;

    public dealcompleteAdapter(){
    ...
    public View getView(int position, View convertView , ViewGroup parnet){
        ...
        if(convertView == null) {
            ...
            convertView = inflater.inflate(R.layout.activity_deal_complete_item, parnet, false);
        }
